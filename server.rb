...
get '/letter/:id' do
  ...
  @exp = {
    ...
    "TCP/IP"=>"",
    "TCP"=>"",
    "Heroku"=>"I have deployed multiple projects to Heroku.",
    ...
    "PostgreSQL"=>"I have experience using PostgreSQL for Rails apps.",
    "C/C++"=>"",
    "Confluence"=>"",
    "Kubernetes"=>"",
    "JIRA"=>"",
    ...
    "SQLite"=>"I have used SQLite for Rails apps.",
